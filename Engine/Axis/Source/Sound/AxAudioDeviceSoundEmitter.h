...
// In order to be able to emit a sound, it needs to have a AxAudioDeviceSound set
class AXDLLCLASS AxAudioDeviceSoundEmitter
{
public:
	AxAudioDeviceSoundEmitter(void);
	virtual ~AxAudioDeviceSoundEmitter(void);
